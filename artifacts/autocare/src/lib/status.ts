...
export const ORDER_STATUS_CONFIG: Record<OrderStatus, { label: string; colorClass: string }> = {
  ...
  awaiting_payment: { label: "Awaiting Payment", colorClass: "bg-amber-100 text-amber-800 border-amber-200 dark:bg-amber-900/30 dark:text-amber-400 dark:border-amber-800" },
