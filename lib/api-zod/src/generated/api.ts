...
export const ListOrdersQueryParams = zod.object({
  ...
  "status": zod.enum(['proposed', 'awaiting_payment', 'placed', 'confirmed', 'shipped', 'delivered', 'cancelled']).optional()
})
...
export const ListOrdersResponseItem = zod.object({
  ...
  "notes": zod.string().nullish(),
  "status": zod.enum(['proposed', 'awaiting_payment', 'placed', 'confirmed', 'shipped', 'delivered', 'cancelled']),
